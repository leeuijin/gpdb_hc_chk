#!/bin/bash
mkdir -p /home/gpadmin/diag/hc_chk/weekly
source /usr/local/greenplum-db/greenplum_path.sh
export LOGFILE=/home/gpadmin/diag/hc_chk/weekly/weekly_db_chk.$(date '+%Y%m%d_%H%M')
export MDWNM=`sed -n '1p' /home/gpadmin/diag/hostfile_master`
export SMDWNM=`sed -n '2p' /home/gpadmin/diag/hostfile_master`

echo "" > ${LOGFILE}
echo "####################" >> ${LOGFILE}
echo "### 1. System Resource Usages Raw data to CSV file" >> ${LOGFILE}
echo "####################" >> ${LOGFILE}
...
echo "" >> ${LOGFILE}
echo "####################" >> ${LOGFILE}
echo "### 2. System Resource Usages each 1 Minute to CSV file - Segment" >> ${LOGFILE}
echo "####################" >> ${LOGFILE}
psql -d gpperfmon -c "COPY(
...
echo "" >> ${LOGFILE}
echo "####################" >> ${LOGFILE}
echo "### 3. System Resource Usages each 10 Minutes to CSV file - Segment" >> ${LOGFILE}
echo "####################" >> ${LOGFILE}
psql -d gpperfmon -c "COPY(
...
echo "" >> ${LOGFILE}
echo "####################" >> ${LOGFILE}
echo "### 4. System Resource Usages each 1 Minute to CSV file - Master" >> ${LOGFILE}
echo "####################" >> ${LOGFILE}
psql -d gpperfmon -c "COPY(
SELECT to_timestamp(floor((extract('epoch' from ctime) / 60 )) * 60) AT TIME ZONE 'Asia/Seoul' as interval_alias,
-- hostname,
...
echo "" >> ${LOGFILE}
echo "####################" >> ${LOGFILE}
echo "### 5. System Resource Usages each 10 Minutes to CSV file - Master" >> ${LOGFILE}
echo "####################" >> ${LOGFILE}
psql -d gpperfmon -c "COPY(
SELECT to_timestamp(floor((extract('epoch' from ctime) / 600 )) * 600) AT TIME ZONE 'Asia/Seoul' as interval_alias,
-- hostname,
...
echo "" >> ${LOGFILE}
echo "####################" >> ${LOGFILE}
echo "### 6. System Resource Usages each 1 Hour to CSV file" >> ${LOGFILE}
echo "####################" >> ${LOGFILE}
psql -d gpperfmon -c "COPY(
...
echo "" >> ${LOGFILE}
echo "####################" >> ${LOGFILE}
echo "### 9. Resource Group Usages each 1 Minute to CSV file" >> ${LOGFILE}
echo "####################" >> ${LOGFILE}
psql -d gpperfmon -c "
...
echo "" >> ${LOGFILE}
echo "####################" >> ${LOGFILE}
echo "### 10. Resource Group Usages each 10 Minute to CSV file" >> ${LOGFILE}
echo "####################" >> ${LOGFILE}
psql -d gpperfmon -c "
