#!/bin/bash
mkdir -p /home/gpadmin/diag/hc_chk/daily
source /usr/local/greenplum-db/greenplum_path.sh
export LOGFILE=/home/gpadmin/diag/hc_chk/daily/db_chk.$(date '+%Y%m%d_%H%M')
...
ORDER BY 1,2,3,4,5 DESC limit 50;" >> ${LOGFILE}
...
echo "####################" >> ${LOGFILE}
psql -d gpperfmon -c "SELECT logmessage, count(*) FROM gpmetrics.gpcc_pg_log_history GROUP BY 1 ORDER BY 2 DESC LIMIT 30;" >> ${LOGFILE}
